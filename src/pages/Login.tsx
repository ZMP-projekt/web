...
export const Login: React.FC = () => {
    ...
    return (
        <div
            className="min-h-screen flex overflow-hidden relative items-center justify-center bg-slate-900 text-slate-200 p-4"
            ...
            <div
                ...
                <div className="flex flex-col items-center mb-8 relative z-10">
                    ...
                    <h2 className="text-4xl text-center text-white tracking-wide"
                        style={{ fontFamily: "'Bebas Neue', sans-serif" }}>{t('login.title')}</h2>
